...
object AnalyticsManager {
    ...
    fun trackVideoEnhanceCancelled() = log("zaki_video_enhance_cancelled")
    ...
    fun trackAudioEnhancePreviewed(source: String = "") =
        log("zaki_audio_enhance_previewed", "source" to source)
